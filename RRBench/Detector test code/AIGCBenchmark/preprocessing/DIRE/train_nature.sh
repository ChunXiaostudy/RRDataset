...
# 输入图像根目录
Imgrootdir="/home/zhuyao123/lcx/RRDataset/test_image/original_image"
# 结果保存的根目录
Saverootdir="/home/zhuyao123/lcx/RRDataset/dire_image/original_image"
...
do
    ...
    mpiexec -n 1 python /home/zhuyao123/lcx/AIGCDetectBenchmark-main/preprocessing/DIRE/compute_dire.py --model_path $MODEL_PATH $MODEL_FLAGS $SAVE_FLAGS $SAMPLE_FLAGS --has_subfolder True --has_subclasses False
done
